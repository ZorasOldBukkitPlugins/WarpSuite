...
import com.mrz.dyndns.server.warpsuite.zorascommandsystem.bukkitcompat.BukkitCommandSystem;
...
public class WarpSuite extends JavaPlugin
{
	...
	public void onEnable()
	{
		...
		cs.registerCommand("{warp|go} reload", new CSBukkitCommand() {

			@Override
			public boolean execute(CommandSender sender, Player player_ignored, String cmdName, String[] preArgs, String[] args)
			{
